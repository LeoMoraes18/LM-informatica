...
function validarFormulario() {
    ...
    var dadosFormStorage = JSON.parse(localStorage.getItem('dadosFormStorage'));
    if (dadosFormStorage == null) {
        dadosFormStorage = [];
    }

    dadosFormStorage.push(dadosFormulario);
    localStorage.setItem('dadosFormStorage', JSON.stringify(dadosFormStorage));

    alert('Formulário enviado com sucesso!\nQuantidade de itens salvos: ' + dadosFormStorage.length);
